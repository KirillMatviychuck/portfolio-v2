...
export const Photo: FC<Props> = ({ animation }) => {
    return (
        <Zoom>
            <div className="w-[410px] h-[410px] 2sm:w-[300px] 2sm:h-[300px]">
                <div className={`flex justify-center items-center w-full h-full rounded-full relative ${animation && "animate-[wiggle_4s_ease-in-out_infinite]"}`}>
                    ...
                    <div className="after:content-[''] absolute w-[380px] h-[380px] bg-gray-800 rounded-full 2sm:w-[260px] 2sm:h-[260px]">
                        <div className="relative w-[380px] h-[380px] rounded-full overflow-hidden 2sm:w-[260px] 2sm:h-[260px]">
