...
export const Skill: FC<Props> = ({ svgPath, title, description }) => {
    return (
        <div className="h-[425px] w-[280px] mx-2 flex flex-col justify-between items-center bg-gray-700 p-[20px] rounded-[20px] 2sm:mt-4 smm:w-full tablet:w-[280px]">
            ...
            <h1 className="text-3xl font-semibold tablet:text-2xl">{title}</h1>
